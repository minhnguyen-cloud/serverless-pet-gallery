...
function credentialExchange(googleToken) {
  ...
  if (googleTokenDecoded['sub']) {
    ...
    AWS.config.credentials = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1:ca10fbb2-228a-41cc-970a-988fff7242d7', // MAKE SURE YOU REPLACE THIS
      Logins: {
...
function accessImages() {
  ...
  var s3 = new AWS.S3();
  var params = {
    Bucket: "webidf-patchesprivatebucket-fnbtfe14vlgs" // MAKE SURE YOU REPLACE THIS
  }; 
